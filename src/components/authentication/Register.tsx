                ...
                <form className="form" method="post" onSubmit={(e) => userRegister(e)}>
                    ...
                    <div className="register__box">
                        ...
                        <div className="input-field">
                            <label htmlFor="first_name" className={`input-field__label caption__regular 
                                    ${isFirstNameError ? 'input-field__label--error' : isFirstNameFocused ? 'input-field__label--focused' : ''}
                                `}>
                                Vorname
                            ...
                            <input
                                    id="first_name"
                                    className={`input-field__content body-normal__regular ${isFirstNameError ? 'input-field__content--error' : ''}`}
                                    type="text"
                                    name="first_name"
                        ...
                        {/*Last Name*/}
                        <div className="input-field">
                            <label htmlFor="last_name" className={`input-field__label caption__regular 
                                    ${isLastNameError ? 'input-field__label--error' : isLastNameFocused ? 'input-field__label--focused' : ''}
                                `}>
                                Nachname
                                {isInputRequired && <span className="input-field__label--required">*</span>}
                            </label>
                            <input
                                    id="last_name"
                                    className={`input-field__content body-normal__regular ${isLastNameError ? 'input-field__content--error' : ''}`}
                                    type="text"
                                    name="last_name"
                        ...
                        {/*Position*/}
                        <div className="input-field">
                            <label htmlFor="position" className={`input-field__label caption__regular 
                                    ${isPositionError ? 'input-field__label--error' : isPositionFocused ? 'input-field__label--focused' : ''}
                                `}>
                                Position
                                {isInputRequired && <span className="input-field__label--required">*</span>}
                            </label>
                            <input
                                    id="position"
                                    className={`input-field__content body-normal__regular ${isPositionError ? 'input-field__content--error' : ''}`}
                                    type="text"
                                    name="position"
                        ...
                        <div className="select-field">
                            <label htmlFor="company_type" className={`select-field__label caption__regular 
                                                    ${isSelectedOptionError ? 'select-field__label--error' : isSelectedOptionFocused ? 'select-field__label--focused' : ''}
                                                `}>
                                Art des Unternehmen
