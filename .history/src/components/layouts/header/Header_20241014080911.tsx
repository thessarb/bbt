...
const Header: React.FC<HeaderProps> = ({ sidebarStatus, toggleSidebar }) => {
  ...
  const handleToggle = () => {
    console.log("Header button clicked to toggle! Sidebar status:", sidebarStatus);
    toggleSidebar(!sidebarStatus); // Toggle the sidebar state
    console.log("Sidebar should be toggled to:", !sidebarStatus);
  };
